...
import enBrands from "@/i18n/locales/en/brands.json";
import viBrands from "@/i18n/locales/vi/brands.json";
import jaBrands from "@/i18n/locales/ja/brands.json";
...
function initTranslations() {
  ...
  registerTranslations("en", "brands", enBrands);
  registerTranslations("vi", "brands", viBrands);
  registerTranslations("ja", "brands", jaBrands);
