...
import { IMAGE_MODEL_OPTIONS } from "@vx/coloring/components";
 ...
 */
// Model choices come from @vx/coloring so this panel, the interior picker and the
// colorize screens never drift apart.
const COVER_MODELS = IMAGE_MODEL_OPTIONS.map((o) => ({
  label: o.value === "" ? "Auto (mặc định)" : o.label,
  value: o.value,
}));
